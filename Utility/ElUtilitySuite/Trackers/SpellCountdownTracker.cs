namespace ElUtilitySuite.Trackers
{
    ...
    internal class SpellCountdownTracker //: IPlugin
    {
        ...
        {
            var menu = rootMenu.AddSubMenu("Spell Countdown", "SPELLCS");

            menu.Add("XPos", new Slider("X Position", this.StartX, 0, Drawing.Width));
            menu.Add("YPos", new Slider("Y Position", this.StartY, 0, Drawing.Height));
            menu.Add("DrawCards", new CheckBox("Draw Cards"));
